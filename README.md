...
- [MDN - Handling Text In JavaScript](https://developer.mozilla.org/en-US/docs/Learn_web_development/Core/Scripting/Strings)
- [MDN - Strings](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String)
- [W3 Schools - JavaScript String Methods](https://www.w3schools.com/js/js_string_methods.asp)

##### Arrays

- [JS Info. Arrays](https://javascript.info/array)
...
- [JS Info. - Objects](https://javascript.info/object)
